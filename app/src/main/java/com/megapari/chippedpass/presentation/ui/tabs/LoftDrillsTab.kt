...
import com.megapari.chippedpass.domain.model.LoftAccuracyDrill
import com.megapari.chippedpass.presentation.ui.components.LoftDrillCard
import com.megapari.chippedpass.presentation.viewmodel.ChippedUiState

@Composable
fun LoftDrillsTab(
    uiState: ChippedUiState,
    onSelectDrill: (LoftAccuracyDrill) -> Unit,
    ...
    LazyColumn(
        ...
        item {
            Column {
                Text(
                    text = "PRECISION LOFT LAB DRILLS",
                    color = ChipBlue,
                    fontSize = 16.sp,
                ...
                Text(
                    text = "Calibrating dead-cushion barrel drops and live over-the-top wall passes.",
                    color = ChipMutedSky,
                    fontSize = 12.sp
                )
            }
